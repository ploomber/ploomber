...
* Upload the file using `upload_file<https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.Client.upload_file>`_ or `upload_from_filename<https://cloud.google.com/python/docs/reference/storage/latest/google.cloud.storage.blob.Blob#google_cloud_storage_blob_Blob_upload_from_filename>`_ for Amazon S3 and Google Storage respectively.
