...
_Note: Ploomber 0.20 dropped support for Python 3.6 ([#876](https://github.com/ploomber/ploomber/issues/876))_
...
_Note: this is the latest version compatible with Python 3.6_
...
- Add _did you mean?_ feature to `ploomber examples` ([#805](https://github.com/ploomber/ploomber/issues/805))
