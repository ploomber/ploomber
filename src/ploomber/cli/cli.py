...
def cmd_router():
    ...
    alias = {'execute': 'build', 'run': 'build', 'bulid' :'build', 'buld': 'build', 'bild':'build', 'uild':'build', 'buil':'build', 'example':'examples', 'exemples':'examples', 'exmples':'examples', 'exampes':'examples', 'tsk':'task', 'tas':'task', 'rport':'report', 'reprt':'report', 'repor':'report', 'stat':'status', 'stats':'status', 'satus':'status', 'inteact':'interact', 'interat':'interact' }
